...
//  Bloxelizer
//
//  Created by The Drudgerist on 8/23/13.
//
//

#ifndef BWO_CUBESET_H
#define BWO_CUBESET_H
...
class CubeSet {
private:
    int width_bits;         // Width/depth of object is width_bits power of two
    int height_bits;        // Height of object is height_bits power of two
public:
...
//    void AddSphere( const glm::vec3 pos, const glm::vec3 radius, const BlockType type );
    ...
    void GetMeshLinear( NormalVertexData* o_verts, unsigned int& numOVerts,
