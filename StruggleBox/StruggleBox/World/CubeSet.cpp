...
//                loaded = true;
//        } else Log::Error("Can't load file:%s", folder.c_str());
//        delete[] data;
//    } else Log::Error("Can't load file, no filename");
//    if ( !loaded ) {
//        Log::Error("Can't load file:%s", fileName.c_str());
...
//        }
//    } else {
//        Log::Debug("Loaded cubeset %s", fileName.c_str());
//    }
//}
//CubeSet::~CubeSet() {
//    delete [] blocks;
...
//            
//			float materialOffset = MaterialData::texOffset(b.blockType);
//
//            int cubeVerts = 0;  // Verts for this block
//			MeshVertexData* gBuffer = NULL;
//			bool opaque = materials[b.blockType].albedo.a == 1.0f;
//            if ( opaque ) { gBuffer = o_verts+totalOVerts; }
...
//                    gBuffer[cubeVerts++] = rtf;
//                }
//                if (opaque ) { totalOVerts += cubeVerts; }
