...
void TextureCache::removeTexture(const TextureID textureID)
{
	...
	auto it2 = m_textureNames.begin();
	while (it2 != m_textureNames.end())
	{
		if (it2->second == textureID)
		{
			m_textureNames.erase(it2);
			break;
		}
		it2++;
	}
