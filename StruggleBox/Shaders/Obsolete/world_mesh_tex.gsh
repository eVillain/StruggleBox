...
void main(void) {
        ...
        VertexOut.texCoord = a; gl_Position = MVP * vec4(a.xyz, 1); EmitVertex();
        VertexOut.texCoord = b; gl_Position = MVP * vec4(b.xyz, 1); EmitVertex();
        VertexOut.texCoord = c; gl_Position = MVP * vec4(c.xyz, 1); EmitVertex();
        VertexOut.texCoord = d; gl_Position = MVP * vec4(d.xyz, 1); EmitVertex();
        EndPrimitive();
