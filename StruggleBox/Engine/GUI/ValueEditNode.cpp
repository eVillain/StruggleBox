...
{
	const glm::vec2 sliderSize = glm::vec2(m_contentSize.x - 4.f, (m_contentSize.y - 4.f) / 4.f);
	...
	m_label->setPositionY((m_contentSize.y - 2.f) - sliderSize.y / 2.f);
	SliderNode* sliderX = m_gui.createDefaultSliderFloat();
	sliderX->setContentSize(sliderSize);
	sliderX->setPosition(glm::vec3(m_contentSize.x - (sliderSize.x + 4.f), (m_contentSize.y - 2.f) - (sliderSize.y * 2.f), 1.f));
	...
	sliderY->setPosition(glm::vec3(m_contentSize.x - (sliderSize.x + 4.f), (m_contentSize.y - 2.f) - (sliderSize.y * 3.f), 1.f));
	...
	sliderZ->setPosition(glm::vec3(m_contentSize.x - (sliderSize.x + 4.f), (m_contentSize.y - 2.f) - (sliderSize.y * 4.f), 1.f));
