...
FileWindow::FileWindow(
	...
	, m_mode(mode)
	, m_callback(nullptr)
	, m_headerLabel(gui.createLabelNode("", GUI::FONT_DEFAULT, 24))
	, m_footerLabel(gui.createLabelNode("", GUI::FONT_DEFAULT, 24))
...
{
	const glm::vec2 FILE_NODE_SIZE = glm::vec2(m_contentNode->getContentSize().x - 2, 24.f);
